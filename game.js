function start() {
    ...
    document.getElementById("speedBear").addEventListener("change", setSpeed,false); //adds an event listener for the input of the speed of the bear

    //create new array for bees
    bees = new Array();
    
    makeBees() //creates bees
...
function Bear() {
    ...
    this.move = function(xDir, yDir) {
        this.fitBounds(); //this is added to keep the bear within board
...
class Bee {
    constructor(beeNumber) {
        ...
        //top position
        this.y = this.htmlElement.offsetTop;
        this.move = function(dx, dy) { //this moves the bees by dx, dy
            this.x += dx;
            this.y += dy;
            this.display();
        };
